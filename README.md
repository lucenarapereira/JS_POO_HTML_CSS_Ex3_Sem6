# JS_POO_HTML_CSS_Ex3_Sem6

Em ‘app.js’, crie uma variável chamada ‘arrayNumeros’, ela é um vetor que possui valores de 1 a 9 (ex.: [1, 2, 3, 4, 5, 6, 7, 8, 9]). 
...
Apresente no console os dois vetores e verifique se funcionou.
